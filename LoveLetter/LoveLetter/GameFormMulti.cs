...
{
    public partial class game_window_multi : Form
    {
        ...
        public game_window_multi(Boolean mute, double main, double music, double effect)
        {
            this.Visible = false;
        ...
        {
            GameControllerMulti.PlayerLeave();
            Thread.Sleep(500);
            ...
            ambianceSound.Stop();
            ambianceSound.Close();
            GameControllerMulti.AskCloseThread();   
        ...
        {
            this.SuspendLayout();
            GameControllerMulti.PickCardMulti(GameControllerMulti.currentPlayer);
            this.ResumeLayout();
            if(GameControllerMulti.currentPlayer.isHuman)
            {
                showIndications("Play 1 card", "player");
            }
        }
        ...
        private void card_Click(object sender, EventArgs e)
        {
            ...
            this.SuspendLayout();
            GameControllerMulti.PlayCardMulti(GameControllerMulti.currentPlayer.player_Deck[index], GameControllerMulti.currentPlayer);
            this.ResumeLayout();
        }
        ...
        private void logBox_btn_Click(object sender, EventArgs e)
        {
